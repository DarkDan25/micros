...
class NotificationService:
    ...
    def send_receipt(self, request: ReceiptRequest) -> NotificationResponse:
        ...
        created = self.notification_repo.create_notification(notification)
        return NotificationResponse(message="Чек отправлен", notification_id=created.notification_id)
    ...
    def trigger_notification(self, request: TriggerRequest) -> TriggerResponse:
        ...
        return TriggerResponse(type=request.type.value, user_id=request.user_id, data=request.data)
